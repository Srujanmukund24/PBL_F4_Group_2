...
const CompanyHome = () => {
    ...
    <div>
     <div className="header">
      <nav class="navbar fixed-top">
        ...
        <h1 style={{color:"white ",paddingTop:"10vh"}}>
 ...
 <br/>
      ...
      {(formSubmitted || companyExists)?(
         <div className="doneForm all text-center justify-content-center mt-5">
        ...
        <div class="row container text-center d-flex justify-content-center">
          <div class="course-col mr-3" style={{height:"60vh"}}>
            ...
            <p>
              Get to know the list of applicants interseted to be a part of your company. 
            </p>
          ...
          <div class="course-col ml-3 " style={{height:"60vh"}}>
            ...
            <p>
              Here is the list of applicants which are part of your organization.
            </p>
